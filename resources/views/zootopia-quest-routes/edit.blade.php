    ...
    <div class="panel">
        <div class="mb-5 flex flex-wrap items-center justify-between gap-3">
            <div>
                ...
                <p class="text-sm text-white-dark">Можна змінити код агента, назву команди і будь-яку підказку маршруту.</p>
            </div>
        ...
        @include('zootopia-quest-routes._form', [
            ...
            'action' => route('zootopia-quest-routes.update', $questRoute),
            'method' => 'PUT',
        ])
    </div>
@endsection
