...
class QuestController extends Controller
{
    ...
    public function result($position)
    {
        $messages = [
            ...
            4 => 'Нажаль сейфів не залишилось, проте ви дійшли до кінця, тому отримуєте 450 ЧЕРІКІВ!',
            5 => 'Нажаль сейфів не залишилось, проте ви дійшли до кінця, тому отримуєте 300 ЧЕРІКІВ!',
        ];
